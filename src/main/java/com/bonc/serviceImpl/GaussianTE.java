 ...
 */
public class GaussianTE implements computeTE,Serializable {
    private int k;
    private int k_tau;
    private int l;
    private int l_tau;
    private int delay;
    //@transient 防止序列化问题
    public transient TransferEntropyCalculatorGaussian calc = new TransferEntropyCalculatorGaussian();
